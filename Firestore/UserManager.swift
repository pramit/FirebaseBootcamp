...
struct DBUser: Codable {
    ...
    init(
        ...
        self.profileImagePathUrl = profileImagePath
    }
...
final class UserManager {
    ...
    //        let dateCreated = data["date_created"] as? Date // pushed as Timestamp, pulled as Date
    //
    ...
    func updateUserProfileImagePath(userId: String, path: String?, url: String?) async throws {
        let data: [String:Any] = [DBUser.CodingKeys.profileImagePath.rawValue : path, DBUser.CodingKeys.profileImagePathUrl.rawValue : url]
